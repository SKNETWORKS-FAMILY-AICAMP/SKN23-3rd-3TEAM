 ...
 * back: POST /upload?analysis_type=... → s3.upload_fileobj()
 *
 * S3 경로:
 *   simple/detailed  → {user_id}/skin-analysis/{uuid}.ext
 *   ingredient      → {user_id}/ingredient-analysis/{uuid}.ext
 */
...
/**
 * 프로필 사진을 S3에 업로드하고 URL 반환.
 * S3 경로: {user_id}/profile/profile.{ext}
 */
