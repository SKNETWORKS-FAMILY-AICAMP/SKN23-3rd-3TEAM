        ...
        <div className="mt-2">
            <div className="flex gap-1 mb-1">
                {[1, 2, 3, 4].map((i) => (
                    <div
                        key={i}
                        className={`flex-1 h-1.5 rounded-full transition-all ${i <= strength && strength === 3 ? "bg-onyou" : ""}`}
                        style={{ background: i <= strength && strength !== 3 ? strengthColor[strength] : i > strength ? "#E5E7EB" : undefined }}
                    />
                ))}
            </div>
            {password && (
                <p className={`text-[11px] font-medium ${strength === 3 ? "text-onyou" : ""}`}
                    style={{ color: strength !== 3 ? strengthColor[strength] : undefined }}>
            ...
            >
                            ...
                            >
                                ...
                                <AnimatePresence>
                                    {codeSent && (
                                        ...
                                        >
                                            {/* 발송 확인 배너 */}
                                            <div className="flex items-center gap-1.5 text-xs text-onyou bg-[#E8F5D0] px-3 py-2 rounded-xl">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center justify-between mt-1">
                                                    <p className="text-[11px] text-gray-400">
                                                        코드 유효 시간:{" "}
                                                        <span className={`font-semibold ${timeLeft > 60 ? "text-onyou" : "text-red-500"}`}>
                                ...
                                <div className="bg-gray-50 rounded-xl p-3">
                                    ...
                                    <ul className="space-y-1">
                                        {[
                                            ...
                                            <li key={rule.label} className={`flex items-center gap-1.5 text-[11px] ${rule.pass ? "text-onyou" : "text-gray-400"}`}>
                                                <div className={`w-3.5 h-3.5 rounded-full flex items-center justify-center ${rule.pass ? "bg-onyou" : "bg-gray-200"}`}>
                        ...
                        {step === 2 && (
                            ...
                            >
                                <motion.div
                                    ...
                                    className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-5 bg-onyou"
                ...
                {step < 2 && (
                    <p className="text-xs text-center text-gray-400 mt-4">
                        <Link to="/login" className="hover:text-onyou transition-colors">← 로그인으로 돌아가기</Link>
                    </p>
                )}
            </motion.div>
        </div>
